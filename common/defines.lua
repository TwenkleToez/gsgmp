...
NDiplomacy = {
	...
	CELESTIAL_EMPIRE_MANDATE_PER_STABILITY = 0.48,	-- Yearly change of Mandate for each point of positive stability
	CELESTIAL_EMPIRE_MANDATE_PER_STATE_WITH_PROSPERITY = 0.06,	-- Yearly change of Mandate for each State with prosperity.
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_DEVASTATION = -2.5,	-- Yearly change of Mandate for each hundred devastated development (scaled to devastation).
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_TRIBUTARY_DEV = 0.30,	-- Yearly change of Mandate for each hundred development tributary state.
	...
	CELESTIAL_EMPIRE_MANDATE_FROM_DEFENDING = 10,	-- How much Mandate is gained when successfully defending the Emperor title.
	CELESTIAL_EMPIRE_MANDATE_PER_5_LOANS = -0.18,	-- Yearly change of Mandate for every 5 loans.
...
NMilitary = {
	...
	MERCENARY_SUPPORT_LIMIT_BASE = 5,				-- Base (and thus minimum) value for mercenary support limit.
	...
	NOMAD_PLAINS_SHOCK_BONUS = 0.2, 				--
	NOMAD_NON_PLAINS_SHOCK_PENALTY = -0.2, 			--
